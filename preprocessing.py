...
class Preprocessing:
    ...
    @staticmethod
    def __convert_and_crop_grayscale(image: Image) -> numpy.array:
    ...
    @staticmethod
    def __scale_down_matrix(raw: numpy.array, width: int, height: int) -> numpy.array:
    ...
    def __prepare_image(self, image) -> numpy.array:
        ...
        result = Preprocessing.__convert_and_crop_grayscale(image)
        result = Preprocessing.__scale_down_matrix(result, img_cols, img_rows)
